...
2. NSFW (Правило 2.4): Порнография (визуальная), хентай, гуро, реальная жестокость.
...
- Абсурдные мемы: Картинки с пришельцами, монстрами, скелетами с текстом про "жопу", "смерть", "зонд", ЕСЛИ это не визуальное порно.
...
- "Мем с инопланетянином и текстом про анальный зонд" -> { violation: false, severity: 15, reason: "Абсурдный мем/Шитпост", comment: "" }
